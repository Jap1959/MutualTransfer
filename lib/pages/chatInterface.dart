          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: results.length==0?Center(child:Text(
                  'No results',
                  style: TextStyle(fontSize: 20, color:kPrimary, fontFamily: 'MonoRoboto'),
                ),):ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ListTile(
                      title: GestureDetector(
                        onTap: (){
                          Get.to(()=>ChatRoomPage(Proffesion: results[index].Proffession, url: results[index].Profilepic, Name: results[index].Name,uid:results[index].uid));
                        },
                        child: Container(
                          width: 1000,
                          height: 100,
                              ...
                              children: [
                                Stack(
                                  children:[
                                    ...
                                    CircleAvatar(
                                      radius: 5,
                                      backgroundColor: results[index].is_online=='true'?Colors.lightGreenAccent:Colors.transparent,
                                      backgroundImage:  NetworkImage(results[index].Profilepic),
                                    ),
                            ],
                                ),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          ...
                                          style: TextStyle(fontSize: 10, color: Colors.black, fontFamily: 'MonoRoboto'),
                                        ),
                                      ),
                                    ],
                                  ),
                                ...
                                Align(
                                  ...
                                  child:  Text(
                                    results[index].is_online=='true'?'online':results[index].LastSeen,
                                    style: TextStyle(fontSize: 15, color: Colors.grey[400], fontFamily: 'MonoRoboto'),
                                  ),
                                )
                              ],
                            ),
          ...
          child: Column(
            children: [
              ...
              Container(
                  height: 400,
                  width: double.infinity,
                child:users.length==0?Center(child:Text(
                  'No Chats ',
                  style: TextStyle(fontSize: 20, color:kPrimary, fontFamily: 'MonoRoboto'),
                ),): ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ListTile(
                      title: GestureDetector(
                        onTap: (){
                          Get.to(()=>ChatRoomPage(Proffesion: users[index].Proffession, url: users[index].Profilepic, Name: users[index].Name, uid: users[index].uid,));
                        },
                        child: Container(
                          width: 1000,
                          height: 100,
                                ...
                                Stack(
                                  children:[
                                    ...
                                    Positioned(
                                      ...
                                      child: CircleAvatar(
                                        radius: 7,
                                        backgroundColor: users[index].is_online=='true'?Colors.lightGreenAccent:Colors.transparent,
                                      ),
                                    ),
                                  ],
                                ),
                        ...
                        Align(
                          alignment: Alignment.topRight,
                          child:  Text(
                            users[index].is_online=='true'?'online':users[index].LastSeen,
                            style: TextStyle(fontSize: 15, color: Colors.grey[400], fontFamily: 'MonoRoboto'),
                          ),
                        )
                              ],
