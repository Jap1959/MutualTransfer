  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Center(child: Text('Create Account',style: TextStyle(fontFamily: 'MonoRoboto',fontSize: 25,fontWeight: FontWeight.bold,color: Colors.white),)),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.fromLTRB(0.0, 40.0, 0.0, 0.0),
                    child:TextfieldPassword( HintText: "Enter Your Password", Password: Pass,),
                  ),
                  Padding(
                    padding: const EdgeInsets.fromLTRB(0.0, 40.0, 0.0, 0.0),
                    child:TextfieldPassword( HintText: "Enter Password Again", Password: Repass,),
                  ),
                  Padding(
                    ...
                    child: GestureDetector(onTap: () async {
                     ...
                     if(EmailValidator.validate(Email.text.toString())&&RePassword==Password){
                        ...
                        Get.snackbar(
                          "Error", "Password do not match or invalid Email",
                          icon: Icon(Icons.close, color: Colors.white),
                          snackPosition: SnackPosition.TOP,
                          backgroundColor: Colors.red,
                        );
                      }
                    }, child: ButtonAPP(Name: "Create Account",icon: Icons.arrow_forward,),
                    ),
                  ),
                  Row(
