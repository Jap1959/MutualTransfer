                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextfieldArea(Email: description, HintText: 'Write About Post.....', color: Colors.white,),
                          ],
                        ),
                      ),
                    ),
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          ...
                          final status=_valid.ValidatePost(Proffession.text.toString(), CurrentPlace.text.toString(), DestinationPlace.text.toString(),description.text.toString(),Name.text.toString());
                          if(uid!=null&&status=='true') {
                            PostUploaddataModel Post = PostUploaddataModel(DestinationPlace: DestinationPlace.text.toString(), Proffession: Proffession.text.toString(), description: description.toString(), PostedByUserid: uid.toString(), MobileNo: Mobile.text.toString(), CurrentPlace: CurrentPlace.text.toString());
                        ...
                        child:state is ButtonPressedState?LoadingButton():ButtonAPP(
